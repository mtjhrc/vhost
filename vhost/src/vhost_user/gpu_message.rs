...
/// The VhostUserGpuEdidRequest from the QEMU vhost-user-gpu specification.
#[derive(Copy, Clone, Debug, Default)]
#[repr(C)]
...
/// The VhostUserGpuUpdate from the QEMU vhost-user-gpu specification.
#[derive(Copy, Clone, Debug, Default)]
#[repr(C)]
...
/// The VhostUserGpuDMABUFScanout from the QEMU vhost-user-gpu specification.
#[derive(Copy, Clone, Debug, Default)]
#[repr(C)]
...
/// The VhostUserGpuDMABUFScanout2 from the QEMU vhost-user-gpu specification.
#[derive(Copy, Clone, Debug, Default)]
#[repr(C, packed)]
...
/// The VhostUserGpuScanout from the QEMU vhost-user-gpu specification.
#[derive(Copy, Clone, Debug, Default)]
#[repr(C)]
